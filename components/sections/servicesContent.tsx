...
interface ServiceProps {
         ...
         },
         {
          serviceName:"data-recovery",
           data:[
            ...
            {title:"Email & Database Recovery",desc:"Lost critical emails or database files? Our expert recovery team retrieves lost, deleted, or corrupted emails and databases from various platforms, ensuring minimal downtime and data integrity. We support Microsoft Exchange, Outlook, SQL databases, and more, helping businesses and individuals recover essential information efficiently.",img:'/data5.jpg'},
            {title:"Server & RAID Data Recovery",desc:"Server and RAID systems are complex, but our team is equipped to handle even the most challenging data loss scenarios. Whether it’s hardware failure, configuration errors, or RAID array corruption, we deliver fast, efficient, and secure recovery services to get your systems back online.",img:'/data3.jpg'},
            {title:"USB Drives & Memory Card Recovery",desc:"Accidental deletion, file corruption, or physical damage shouldn’t mean losing precious files stored on all types of flash storage devices, including USB drives, SD cards, and microSD cards. At Alpha Vision Technology, we offer specialized recovery services for these portable storage devices, ensuring retrieval of photos, videos, documents, and more. Using non-invasive methods and state-of-the-art technology, we handle each case with precision and care. Let us help you recover what matters most—quickly and securely.",img:'/data4.jpg'},
            {title:"Mobile Device Data Recovery",desc:"In today’s digital age, mobile devices store invaluable personal and professional data. If you’ve lost data due to accidental deletion, water damage, software glitches, or hardware failure, Alpha Vision Technology is here to assist. We support a wide range of smartphones and tablets, including iOS and Android devices, employing advanced recovery techniques to restore contacts, messages, photos, apps, and more. With strict adherence to privacy standards, we ensure your data remains safe while delivering exceptional results.",img:'/data2.jpg'},
           ]
         },
         {
  ...
  return (
    ...
    <h2 className="mb-3 text-4xl sm:text-h4 md:text-h3 lg:text-h2 font-grotesk font-semibold capitalize">
        {pathname.replace("-"," ").includes("consulting")? "IT Consulting": pathname.replace("-"," ")}
    </h2>
    {/* <p className="text-md md:text-lg text-gray">
